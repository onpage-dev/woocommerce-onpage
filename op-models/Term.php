...
class Term extends Model {
    ...
    public function terms(string $name = null) {
      $q = $this->belongsToMany(Term::class, TermMeta::class, 'term_id', 'meta_value', null, 'op_id');
    ...
    public function posts(string $name = null) {
      $q = $this->belongsToMany(Post::class, TermMeta::class, 'term_id', 'meta_value', null, 'op_id');
      if ($name) $q->wherePivot('meta_key', "op_$name");
      return $q;
    }
